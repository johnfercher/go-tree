...
func TestTree_AddRoot_WhenTreeIsEmpty_ShouldReturnTrue(t *testing.T) {
	...
	// Act
	added := sut.AddRoot(tree.NewNode(42))
...
func TestTree_AddRoot_WhenTreeIsNotEmpty_ShouldReturnFalse(t *testing.T) {
	...
	// Act
	_ = sut.AddRoot(tree.NewNode(42))
	added := sut.AddRoot(tree.NewNode(43))
...
func TestTree_Add_WhenThereIsNoRoot_ShouldReturnFalse(t *testing.T) {
	...
	// Act
	added := tr.Add(0, tree.NewNode(42))
...
func TestTree_Add_WhenRootIsNotRight_ShouldReturnTrue(t *testing.T) {
	...
	// Act
	_ = tr.AddRoot(tree.NewNode(42))
	added := tr.Add(3, tree.NewNode(42))
...
func TestTree_Get_WhenThereIsNoId_ShouldReturnFalse(t *testing.T) {
	...
	tr.AddRoot(tree.NewNode("0"))
	tr.Add(0, tree.NewNode("1.0"))
...
func TestTree_Get_WhenThereIsId_ShouldReturnTrue(t *testing.T) {
	...
	tr.AddRoot(tree.NewNode("0").WithID(0))
...
func TestTree_Backtrack_WhenIdFound_ShouldReturnTrue(t *testing.T) {
	...
	tr.Add(0, tree.NewNode("1.0").WithID(1))
	tr.Add(1, tree.NewNode("2.0").WithID(2))
	tr.Add(2, tree.NewNode("3.0").WithID(3))
...
func TestTree_GetStructure_WhenThereIsRoot_ShouldReturnTrue(t *testing.T) {
	...
	tr.AddRoot(tree.NewNode("0.0"))
	tr.Add(0, tree.NewNode("1.0"))
	tr.Add(0, tree.NewNode("1.1"))
	tr.Add(0, tree.NewNode("1.2"))
	tr.Add(1, tree.NewNode("2.0"))
	tr.Add(1, tree.NewNode("2.1"))
	tr.Add(1, tree.NewNode("2.2"))
	tr.Add(2, tree.NewNode("2.0"))
	tr.Add(2, tree.NewNode("2.1"))
	tr.Add(2, tree.NewNode("2.2"))
	tr.Add(3, tree.NewNode("3.0"))
	tr.Add(3, tree.NewNode("3.1"))
	tr.Add(3, tree.NewNode("3.2"))
	tr.Add(4, tree.NewNode("4.0"))
